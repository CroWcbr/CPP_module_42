...
ClapTrap::ClapTrap( std::string name ): 
					...
					_attack_damage(0)
{
	std::cout << "Default constructor called for <" + this->getName() + "> " << this << std::endl;
};

ClapTrap::~ClapTrap( void )
{
	std::cout << "Destructor called for <" + this->getName() + "> " << this << std::endl;
};
...
{
	*this = copy;
	std::cout << "Copy constractor called for <" + this->getName() + ">" << std::endl;
}
